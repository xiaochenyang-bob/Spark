...
<%
	...
	ResultSet rs1= null;
	ResultSet rs2 = null;
	String searchString = "SELECT Users.id AS id, Users.username AS username FROM Matches" +
			" JOIN Users ON Users.id = Matches.t WHERE f = ? ORDER BY match_date DESC;";
	String findAvatarLink = "SELECT username FROM Users WHERE id = ? ;";
	...
	String avatar_url = avatars.get(from_id);
	try{
	...
	<div class = "container-fluid">
		    ...
		    %>
		    	<div class = "col col-lg-3 col-md-4 col-sm-6 user_avatar">
					<img src = "<%= avatars.get(user_Ids.get(i)) %>" alt = "<%= user_Ids.get(i) %>" class = "liked_profiles">
					<p><%= usernames.get(i) %></p>
